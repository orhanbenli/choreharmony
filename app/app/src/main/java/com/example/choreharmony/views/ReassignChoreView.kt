...
import com.example.choreharmony.viewmodel.ReassignChoreViewModel

@OptIn(ExperimentalMaterial3Api::class, ExperimentalMaterialApi::class)
@Composable
fun ReassignChoreView(
    viewModel: ReassignChoreViewModel = hiltViewModel(),
        ...
        content = { padding ->
            Box(
                ...
                if (viewModel.assignableMembersLoading.value ||
                    viewModel.reassignChoreLoading.value) {
                    return@Scaffold Box(
                        contentAlignment = Alignment.Center,
                        modifier = Modifier
                            .fillMaxSize()
                ...
                Box(
                    ...
                    FloatingActionButton(
                        modifier= Modifier
                            ...
                            .padding(16.dp),
                        backgroundColor = MaterialTheme.colorScheme.primary,
                        onClick = { viewModel.reassignChore(choreId) {
                            navController.popBackStack()
                        } }) {
                        Icon(imageVector = Icons.Filled.Check, contentDescription = "Reassign Chore", tint = Color.White)
                    }
                }
            }
        }
